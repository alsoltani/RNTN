...
class SentimentAnalysis:
    ...
    def __init__(self, args=None):
        ...
        compared to the Numpy implementation."""
        ...
        parser.add_option("--epochs", dest="optim_epochs", type="int", default=10)
        parser.add_option("--lr", dest="learning_rate", type="float", default=1e-3)
    ...
    def test(self):
        ...
        cost, correct, total = test_rntn.cost_and_updates(trees, test=True)
